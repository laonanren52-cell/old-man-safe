    ...
    <SectionCard>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-black text-slate-950">小满给家属的总结</h3>
        </div>
      ...
      <p className="mt-5 rounded-[1.25rem] bg-[#f4fbf9] p-5 text-lg leading-9 text-slate-800">{report.xiaomanMessage}</p>
