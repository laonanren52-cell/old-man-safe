...
export function BestRoutePanel({ recommendation }: BestRoutePanelProps) {
  return (
    <SectionCard className="bg-[#f4fbf9]">
      <p className="text-sm font-bold text-[#2f6f68]">小满推荐路线</p>
      <h3 className="mt-2 text-2xl font-black text-slate-950">{recommendation.bestRoute.name}</h3>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-[1rem] bg-white p-4">
          <p className="text-sm font-bold text-slate-500">老人友好</p>
